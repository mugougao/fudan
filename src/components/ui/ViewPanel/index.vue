    ...
    <div class="flex flex-auto">
      <TransitionFadeInLeft>
        <div
          ...
          :class="showDataPanel ? 'w-360px pl-5' : 'w-0'">
          <div class="relative h-full w-340px" :class="leftGrid && 'grid grid-rows-24 grid-cols-1 gap-15px'">
      ...
      <TransitionFadeInRight>
        <div
          ...
          :class="showDataPanel ? 'w-360px pr-5' : 'w-0'">
          <div class="relative h-full w-340px" :class="rightGrid && 'grid grid-rows-24 grid-cols-1 gap-15px'">
