...
// import landscape from "@/assets/images/campusStyle/landscape.png";
...
const introduce = computed(() => {
  if (!props.introduce) return "";
  if (!props.fristWord) return props.introduce;
  return props.introduce?.replace(props.fristWord, "");
});
