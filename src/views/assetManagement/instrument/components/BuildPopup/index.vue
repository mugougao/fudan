...
<template>
  <DragPopup
    ...
    @close="emits('close')">
    <UiThirdTitle title="大型仪器数"></UiThirdTitle>
    <NumberOfLargeInstruments :data="largeInstrumentData" @details="setTerminalDetailsPopupVisible(true)" />
    <UiThirdTitle title="使用方向"></UiThirdTitle>
    <UseDirections :data="useDirectionsData" />
    <div class="relative">
      <UiThirdTitle title="设备分布"></UiThirdTitle>
      <button
        type="button" class="absolute top-0 right-0 rounded-lg bg-transparent px-1.5 py-0.5 text-12px text-#9E9E9E hover:bg-gray-100/10"
